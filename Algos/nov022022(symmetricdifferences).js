...
//     let differenceA = new Set([...setA].filter((x) => !setB.includes(x)))
//     let differenceB = new Set([...setB].filter((x) => !setA.includes(x)))
//     return Array.from(differenceA).concat(Array.from(differenceB));
// }
